  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto w-full">
        <div className="grid lg:grid-cols-[1fr_400px] gap-10 lg:gap-12 items-center">
          {/* LEFT — identity */}
          <div>
            ...
            <motion.h1
              {...fadeUp(0.1)}
              className="font-mono font-bold leading-[0.95] tracking-tight text-white text-5xl sm:text-7xl md:text-8xl"
            >
              VARUN
              <br />
            ...
            <motion.div {...fadeUp(0.3)} className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          {/* RIGHT — now panel (desktop only) */}
          <motion.div {...fadeUp(0.35)} className="hidden lg:block">
            <Now />
          </motion.div>
        </div>
